...
Realiza la imputación de observaciones faltantes por medio de procesos gaussianos.
...
df = pd.read_csv(home+"data/preprocessed/indicators_normalized.csv")
...
dff.to_csv(home+"data/preprocessed/indicators_imputed.csv", index=False)
