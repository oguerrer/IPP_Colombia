...
Corre simulaciones prospectivas y guarda los resultados.
...
dfi.to_csv(home+"data/sims/prospective.csv", index=False)
...
dfp.to_csv(home+"data/sims/prospective_Ps.csv", index=False)
