...
Toma los datos originales de los indicadores de gobernanza y cambia el formato
de la tabla.
...
dffc = dfcc_clean[dfcc_clean.countryCode.isin(['COL'])]
dffr = dfrl_clean[dfrl_clean.countryCode.isin(['COL'])]
